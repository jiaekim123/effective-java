...
- [아이템 71. 필요 없는 검사 예외 사용은 피하라](markdown/chapter10/item71.md)
- 아이템 72. 표준 예외를 사용하라
...
## 11장 동시성
- [아이템 78. 공유 중인 가변 데이터는 동기화해 사용하라](markdown/chapter11/item78.md)
- 아이템 79. 과도한 동기화는 피하라
...
## 12장 직렬화
- [아이템 85. 자바 직렬화의 대안을 찾으라](markdown/chapter12/item85.md)
